...
const styles = StyleSheet.create({
  ...
  pill: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: radii.sm, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: colors.divider, height: 26, justifyContent: 'center' },
