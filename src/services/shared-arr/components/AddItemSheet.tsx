...
const styles = StyleSheet.create({
  ...
  pickerItem: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: radii.round, backgroundColor: 'rgba(255,255,255,0.04)', borderWidth: 1, borderColor: colors.divider },
