...
const styles = StyleSheet.create({
  ...
  pickerItem: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: radii.round, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: colors.divider },
  ...
  checkbox: { width: 22, height: 22, borderRadius: 6, borderWidth: 2, borderColor: colors.divider, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.08)' },
