      ...
      {!isSearchMode && (
        <>
          ...
          <Pressable style={styles.discoverEntry}
            onPress={() => navigation.navigate('DiscoverBrowse', { mediaType: 'movie', title: 'Discover', feed: { kind: 'discover' } })}>
            <Ionicons name="compass-outline" size={20} color={colors.primary} />
            <View style={{ flex: 1 }}>
              <Text style={styles.discoverEntryTitle}>Discover</Text>
              <Text style={styles.discoverEntrySub}>Filter by genre, language, country and sort by ratings</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  notConfigured: { marginHorizontal: spacing.xl, marginBottom: spacing.lg, padding: spacing.lg, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12, borderWidth: 1, borderColor: colors.divider },
